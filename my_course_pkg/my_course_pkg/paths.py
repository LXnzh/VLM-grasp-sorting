...
# Artifacts that explain how the RGB-D sorting logic selected a release point.
# Kept separate from the raw RGB-D frame so each file has an unambiguous role.
SORTING_OUTPUT_DIR = OUTPUT_DIR / "sorting"
