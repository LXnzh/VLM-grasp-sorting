...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'sim_target_nudge = my_course_pkg.tasks.tracking.sim_target_nudge:main',
            'foundationpose_tracking_grasp = my_course_pkg.tasks.tracking.foundationpose_grasp:main',
            'pbvs_follow_stop_grasp = my_course_pkg.tasks.pbvs.follow_stop_grasp:main',
        ],
    },
)
